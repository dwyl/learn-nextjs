      ...
      <div className="flex grow flex-col justify-between rounded-xl bg-gray-50 p-4">
        { <ul role="list" className="divide-y divide-gray-100 overflow-hidden bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
          {latestPosts.map((post, i) => {
            return (
              <li key={post.id} className="relative flex justify-between gap-x-6 px-4 py-5 hover:bg-gray-50 sm:px-6">
              ...
              <div className="flex shrink-0 items-center gap-x-4">
                <div className="hidden sm:flex sm:flex-col sm:items-end">
                  <p className="text-sm leading-6 text-gray-900">from user {post.userId}</p>
                </div>
